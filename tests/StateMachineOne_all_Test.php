...
class StateMachineOne_all_Test extends TestCase
{
    ...
    public function test_1(): void
    {
        ...
        unset($job->fields['_time']);
        self::assertEquals(['pedal' => 0, 'turnkey' => 0, 'gas' => 100, 'brake' => 0, 'speed' => 0, '_idjob' => 1,
            '_state0' => 1], $job->fields);
        $job->fields['pedal'] = 1;
        $job->fields['turnkey'] = 1;
        // I push the pedal and I turn the key. gas > 0
        $this->state->checkJob($job);
        unset($job->fields['_time']);
        self::assertEquals(['pedal' => 1, 'turnkey' => 1, 'gas' => 100, 'brake' => 0, 'speed' => 0
        ,    '_idjob' => 1,
    '_state0' => 2,
    ...
    '_state1' => 2
        ...
        $this->state->checkJob($job);
        unset($job->fields['_time']);
        self::assertEquals(['pedal' => 1, 'turnkey' => 1, 'gas' => 100, 'brake' => 0, 'speed' => 2
        ,    '_idjob' => 1,
    '_state0' => 3,
    '_result' => 'change',
    '_state1' => 3
        ...
        $this->state->checkJob($job);
        unset($job->fields['_time']);
        self::assertEquals(['pedal' => 1, 'turnkey' => 1, 'gas' => 100, 'brake' => 1, 'speed' => 0
        ,    '_idjob' => 1,
    '_state0' => 2,
    '_result' => 'change',
    '_state1' => 2
        ...
        $this->state->checkJob($job);
        unset($job->fields['_time']);
        self::assertEquals(['pedal' => 1, 'turnkey' => 0, 'gas' => 100, 'brake' => 1, 'speed' => 0,
            '_idjob' => 1,
    '_state0' => 2,
    '_result' => 'stop',
    '_state1' => 1
