...
include 'BuildMilkClass.php';
echo "<h1>Using the class created in the previous step</h1>";

$smachine=new StateMachineOne(null,'BuildMilkClass');
...
//($this, $dict, ['wait', 'always','timestate'], ['timeout', 'fulltimeout'], $serviceObject);
$dict=[];
/*
$smachine->miniLang=new BuildMilkClass($smachine, $dict, ['wait', 'always','timestate'], ['timeout', 'fulltimeout']
    , $smachine->serviceObject);
*/
$smachine->setDebug(true);
...
$smachine->getDB()->throwOnError=true;
